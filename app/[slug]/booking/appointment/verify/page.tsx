      ...
      <div className="w-full max-w-sm text-center">
        {status === 'loading' && (
          <>
            ...
            <p className="text-sm text-[var(--ink-soft)]">Please wait while we confirm your appointment.</p>
          </>
        )}
        ...
        {status === 'success' && (
          <>
            ...
            <h1 className="text-2xl font-bold mb-2 text-[var(--ink)]">Appointment confirmed</h1>
            <p className="text-sm mb-8 text-[var(--ink-soft)]">Your appointment has been confirmed and the barbershop has been notified.</p>
            <a
              href={`/${slug}`}
        ...
        {status === 'alreadyVerified' && (
          <>
            ...
            <h1 className="text-2xl font-bold mb-2 text-[var(--ink)]">Already confirmed</h1>
            <p className="text-sm mb-8 text-[var(--ink-soft)]">This appointment has already been verified. No further action is needed.</p>
            <a
              href={`/${slug}`}
              className="inline-block px-6 py-3 rounded-xl font-semibold text-sm bg-[var(--accent)] text-[var(--ink)] pressable shadow-[var(--shadow-accent)] no-underline"
            >
