      ...
      <div className="w-full max-w-sm text-center">
        {status === 'loading' && (
          <>
            ...
            <p className="text-sm text-[#6b7280]">Please wait while we confirm your identity.</p>
          </>
        )}
        ...
        {status === 'success' && (
          <>
            ...
            <h1 className="text-2xl font-black mb-2 text-[#1a1a1a]">Identity Verified!</h1>
            <p className="text-sm mb-8 text-[#6b7280]">Your identity has been confirmed. Your booking history will be linked to your account.</p>
            <a
              href={`/${slug}`}
        ...
        {status === 'alreadyVerified' && (
          <>
            ...
            <h1 className="text-2xl font-black mb-2 text-[#1a1a1a]">Already Verified</h1>
            <p className="text-sm mb-8 text-[#6b7280]">Your identity has already been verified. No further action is needed.</p>
            <a
              href={`/${slug}`}
              className="inline-block px-6 py-3 rounded-2xl font-bold text-sm transition-opacity bg-[#ffc81e] text-[#1a1a1a] no-underline"
            >
